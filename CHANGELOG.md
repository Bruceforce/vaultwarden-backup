## [2.1.6](https://gitlab.com/1O/vaultwarden-backup/compare/v2.1.5...v2.1.6) (2026-07-01)


### Bug Fixes

* **deps:** update alpine docker tag to v3.24.1 ([68a266b](https://gitlab.com/1O/vaultwarden-backup/commit/68a266baad1cf51f5c2d3803f813f2ea0fd02d77))

## [2.1.5](https://gitlab.com/1O/vaultwarden-backup/compare/v2.1.4...v2.1.5) (2026-05-01)


### Bug Fixes

* **deps:** update alpine docker tag to v3.23.4 ([c5efab5](https://gitlab.com/1O/vaultwarden-backup/commit/c5efab58a75e67b24678eb599fb0de00540a6125))
...
* **deps:** update alpine docker tag to v3.23.2 ([8780043](https://gitlab.com/1O/vaultwarden-backup/commit/8780043e2a115d293532d4c8054d71535168220d))

## [2.1.2](https://gitlab.com/1O/vaultwarden-backup/compare/v2.1.1...v2.1.2) (2025-12-07)


### Bug Fixes

* **deps:** update alpine docker tag to v3.23.0 ([811a7a9](https://gitlab.com/1O/vaultwarden-backup/commit/811a7a956902b05d44c34de01dc290a0dadb1706))
